...
export declare class CustomConfirmPopupComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CustomConfirmPopupComponent, "custom-confirm-popup", never, { "modalText": { "alias": "modalText"; "required": true; }; "type": { "alias": "type"; "required": true; }; "modalIcon": { "alias": "modalIcon"; "required": false; }; "modalIconClass": { "alias": "modalIconClass"; "required": false; }; "modalSubText": { "alias": "modalSubText"; "required": false; }; "confirmButtonText": { "alias": "confirmButtonText"; "required": false; }; "confirmButtonStyle": { "alias": "confirmButtonStyle"; "required": false; }; "cancelButtonStyle": { "alias": "cancelButtonStyle"; "required": false; }; "cancelButtonText": { "alias": "cancelButtonText"; "required": false; }; "successMsg": { "alias": "successMsg"; "required": false; "isSignal": true; }; }, { "confirmEvent": "confirmEvent"; "cancelEvent": "cancelEvent"; "overlayClicked": "overlayClicked"; "closed": "closed"; }, never, never, true, never>;
}
